...
/**
 * wraps an ObjectDataMap and keeps track of what data was created; this is then
 * used to serialize the data and walk the data structure.
 * 
 * @author jeffrey
 */
public class LinkedDataMap {
  ...
  public LinkedDataMap(ObjectDataMap data) {
    this.data = data;
  ...
  private <T extends Edit> T link(String name, T edit) {
    links.put(name, edit);
    return edit;
  }
