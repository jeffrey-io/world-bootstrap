...
public class TestCirclePart extends WorldTestFramework {
  ...
  public void verify() {
    ...
    CirclePart circle = new CirclePart();
    ...
    Polygon notTouching = MousePart.transformSelectionWindow(window, new IdentityTransform());
    assertFalse(circle.selectionIntersect(notTouching, Mode.Add));
    
    window = mouse.dragTo(1, 1);
    Polygon touching = MousePart.transformSelectionWindow(window, new IdentityTransform());
